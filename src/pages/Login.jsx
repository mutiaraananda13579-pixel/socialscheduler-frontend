      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <div className="relative bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl shadow-blue-500/10">
          ...
          <div className="absolute -bottom-3 -left-3">
            <SparklesIcon className="w-6 h-6 text-purple-400/70 animate-pulse-slow animation-delay-2000" />
          </div>
          ...
          <div className="text-center mb-8">
            <div className="relative inline-block">
              ...
              <div className="relative inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-500 rounded-2xl shadow-lg shadow-blue-500/30 mb-4 ring-2 ring-blue-400/20">
                <CalendarDaysIcon className="w-10 h-10 text-white drop-shadow-lg" />
              </div>
            </div>
          ...
          {/* Error Alert */}
          {error && (
            <div className="mb-4 p-3 bg-red-500/10 border border-red-500/30 rounded-xl flex items-start gap-2 text-red-400 text-sm backdrop-blur-sm animate-shake">
          ...
          {/* Success Alert */}
          {success && (
            <div className="mb-4 p-3 bg-emerald-500/10 border border-emerald-500/30 rounded-xl flex items-start gap-2 text-emerald-400 text-sm backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <EnvelopeIcon className="h-5 w-5 text-slate-500 group-hover:text-blue-400 transition-colors" />
                </div>
                <input
                  type="email"
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-900/50 border border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all duration-300 placeholder:text-slate-500 text-white hover:border-slate-600"
                />
              </div>
            </div>
            ...
            <div className="group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <LockClosedIcon className="h-5 w-5 text-slate-500 group-hover:text-blue-400 transition-colors" />
                </div>
                <input
                  ...
                  className="w-full pl-10 pr-12 py-3 bg-slate-900/50 border border-slate-700 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all duration-300 placeholder:text-slate-500 text-white hover:border-slate-600"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="relative w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-xl font-medium text-white transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-blue-500/40 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2 shadow-lg shadow-blue-500/25 group overflow-hidden"
            >
